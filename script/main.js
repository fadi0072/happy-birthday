...
document.addEventListener("DOMContentLoaded", function () {
  ...
  let currentDay = 1; // Starting day (January 1st)
  let currentMonthIndex = 0; // Starting month (January, 0-indexed)
  let currentYear = birthYear; // Starting year (birth year)
  let currentAge = 0; // Starting age
